...
final PlantsModel plantsModel;
  const PlantCard({super.key, required this.plantsModel});
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    if (plantsModel.status != null) ...[
                      AppBadge(text: plantsModel.status!),
                    ...
                    CustomButton(
                      ...
                      onPressed: () {
                        context.pushWithNamed(Routes.plantDetailsView,
